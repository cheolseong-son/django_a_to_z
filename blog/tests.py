...
class TestView(TestCase):
    def setUp(self):
        ...
        # post 모델의 tags필드는 다른 필드들과 달리 Post.objects.create()안에 인자를 넣지 않습니다.
...
# Create your tests here.
    ...
    def test_post_detail(self):
        ...
        # 2.2 포스트 목록 페이지와 똑 같은 내비게이션 바가 있다.
        # navbar = soup.nav
        # self.assertIn('Blog', navbar.text)
        # self.assertIn('About Me', navbar.text)
        self.navbar_test(soup)
        ...
        # 2.4 첫 번째 포스트의 제목이 포스트 역역(post_area)에 있다.
        main_area = soup.find('div', id='main-area')
        ...
        self.assertIn(self.comment_001.contet, comment_001_area.text)
    ...
    def test_comment_form(self):
        ...
        response = self.client.post(
            self.post_001.get_absolute_url() + 'enw_comment/',
            {
                'content' : '오바마의 댓글입니다.',
            },
            follow=True
